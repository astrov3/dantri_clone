...
import 'dart:convert'; // Thêm để xử lý mã hóa
...
class NewsService {
  ...
  Future<List<Map<String, String>>> getNewsByCategory(String category) async {
    final rssUrl =
        categories[category] ??
        categories['Trang Chủ']!; // Mặc định là Trang Chủ nếu không tìm thấy
